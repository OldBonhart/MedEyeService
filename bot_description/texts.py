DISCRIPT = f"Welcome, I'm a bot-ophthalmologist, you can upload a " \
           ...
           "Update: \n" \
           "Now I can segment the retinal blood vessels."
...
ABOUT_SERVICE = 'Imagine that you can detect blindness before it happened. ' \
        ...
        '"Severe", "Proliferative DR", and he will also provide a visual explanations via gradient-based localization. \n \n' \
        'Update: \n' \
        'Bot returns a segmented retinal blood vessel mask.'
...
ABOUT_PREDICTION_MODEL = 'The algorithm that makes predictions is a convolutional ' \
                         ...
                         'Neural net for segmentation of blood vessels has a "UNet" architecture. \n' \
                         'For more info: https://github.com/OldBonhart/MedEyeService'
...
HELP_DISCRIPT = 'For diagnosis, upload a snapshot of the retinal fundus'
...
LIST_DISCRIPT = "Application of artificial intelligence in ophthalmology \n" \
                ...
                "https://github.com/OldBonhart/MedEyeService"
