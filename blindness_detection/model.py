...
from blood_vessels_segmentation.model import unet_make_predict
...
class MakePredict():
    ...
    def crop_image_from_gray(self, img, tol=7):
        if img.ndim == 2:
            ...
            return img.astype(np.uint8)  # convet to np.uint8
    ...
    def make_predict(self, image):
        ...
        seg_prediction = unet_make_predict(img_tensor)
        ...
        return probabilities, label, heatmap, seg_prediction
